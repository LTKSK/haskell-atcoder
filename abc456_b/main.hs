...
main = do
  ...
  as2 <- ints
  as3 <- ints
  let as1_4 = length $ filter (== 4) as1
      as1_5 = length $ filter (== 5) as1
      as1_6 = length $ filter (== 6) as1
      as2_4 = length $ filter (== 4) as2
      as2_5 = length $ filter (== 5) as2
      as2_6 = length $ filter (== 6) as2
      as3_4 = length $ filter (== 4) as3
      as3_5 = length $ filter (== 5) as3
      as3_6 = length $ filter (== 6) as3
      t = 6 ^ 3
      _456 = as1_4 * as2_5 * as3_6
      _465 = as1_4 * as2_6 * as3_5
      _546 = as1_5 * as2_4 * as3_6
      _564 = as1_5 * as2_6 * as3_4
      _645 = as1_6 * as2_4 * as3_5
      _654 = as1_6 * as2_5 * as3_4
  print $ fromIntegral (_456 + _465 + _546 + _564 + _645 + _654) / fromIntegral t